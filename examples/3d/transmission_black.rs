    ...
    commands.spawn((
       ...
       PbrBundle {
           ...
           transform: Transform {
               ...
               // With the quad at 1.0 on the Y axis does not exhibit the black artifacts
               translation: Vec3::new(0.25, 1.0, -2.0),

               // Raising the quad 0.5 higher on the Y axis does not exhibit the black artifacts
               // translation: Vec3::new(0.25, 1.5, -2.0),
...
fn camera_control_system(
    ...
    let yaw = if input.pressed(KeyCode::ArrowRight) {
        time.delta_seconds()
